...
<div class="card">
    <div class="card-header">
        ...
        <a href="{{ route('admin_category_create') }}">
            <button type="button" class="btn float-right bg-gradient-success">Create Category </button>
        </a>
            ...
            <tbody>
                ...
                @foreach ($data as $item)
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-info btn-bg" href="{{ route('admin_category_edit', $item->id) }}"
                                title="Edit">
                                <i class="fas fa-pencil-alt"></i>
                            </a>


                            <a class="btn btn-danger btn-bg" href="{{ route('admin_category_delete', $item->id) }}"
