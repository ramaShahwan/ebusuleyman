...
<body>
                            ...
                            <ul>
                                ...
                                <li>
                                    <div class="header-icons">
                                        <a class="shopping-cart" href="{{ asset('cart.html') }}"><i
    ...
    <!-- hero area -->
    <div class="hero-area hero-bg" style="background-image: url('{{ asset('frontend/assets/img/hero-bg.jpg') }}')">
        <div class="container">
            <div class="row">
                <div class="col-lg-9 offset-lg-2 text-center">
                    <div class="hero-text">
                        <div class="hero-text-tablecell">
                            ...
                            <div class="hero-btns">
                                <a href="{{ asset('shop.html') }}" class="boxed-btn">Fruit Collection</a>
                                <a href="{{ asset('contact.html') }}" class="bordered-btn">Contact Us</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row product-lists">
                    ...
                    <div class="single-product-item">
                        <div class="product-image">
                            <a href="single-product.html"><img
                                    src="{{ asset('frontend/assets/img/products/product-img-1.jpg') }}"
                                    alt=""></a>
                        </div>
                        <h3>Strawberry</h3>
                ...
                <div class="col-lg-4 col-md-6 text-center berry">
                    <div class="single-product-item">
                        <div class="product-image">
                            <a href="single-product.html"><img
                                    src="{{ asset('frontend/assets/img/products/product-img-2.jpg') }}"
                                    alt=""></a>
                        </div>
                        <h3>Berry</h3>
                ...
                <div class="col-lg-4 col-md-6 text-center lemon">
                    <div class="single-product-item">
                        <div class="product-image">
                            <a href="single-product.html"><img
                                    src="{{ asset('frontend/assets/img/products/product-img-3.jpg') }}"
                                    alt=""></a>
                        </div>
                        <h3>Lemon</h3>
                ...
                <div class="col-lg-4 col-md-6 text-center">
                    <div class="single-product-item">
                        <div class="product-image">
                            <a href="single-product.html"><img
                                    src="{{ asset('frontend/assets/img/products/product-img-4.jpg') }}"
                                    alt=""></a>
                        </div>
                        <h3>Avocado</h3>
                ...
                <div class="col-lg-4 col-md-6 text-center">
                    <div class="single-product-item">
                        <div class="product-image">
                            <a href="single-product.html"><img
                                    src="{{ asset('frontend/assets/img/products/product-img-5.jpg') }}"
                                    alt=""></a>
                        </div>
                        <h3>Green Apple</h3>
                ...
                <div class="col-lg-4 col-md-6 text-center strawberry">
                    <div class="single-product-item">
                        <div class="product-image">
                            <a href="single-product.html"><img
                                    src="{{ asset('frontend/assets/img/products/product-img-6.jpg') }}"
                                    alt=""></a>
                        </div>
                        <h3>Strawberry</h3>
